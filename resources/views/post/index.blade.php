        ...
        <div class="card mt-3">
            ...
            @if ($post->user->id == Auth::user()->id)
                <div class="post_edit text-right">
                    <a class="btn btn-primary btn-sm" href="{{ route('posts.edit', ['post' => $post]) }}"><i class="far fa-edit"></i>編集
                    </a>
                    <a class="btn btn-danger btn-sm" rel="nofollow" href="/postsdelete/{{ $post->id }}"><i class="far fa-trash-alt"></i>削除
                    </a>
                </div>
                @endif
                <h3 class="h5 title">
